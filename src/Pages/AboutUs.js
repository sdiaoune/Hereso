    ...
    return (
      <div className="App">
        <section className="App-section">
          ...
          <br/>
          <p>Welcome to the Niarela Apartment Complex, the epitome of opulent living in Bamako, Mali. Our prime location, just 5 minutes from the bustling downtown area, offers residents the perfect blend of urban convenience and serene luxury.</p>
